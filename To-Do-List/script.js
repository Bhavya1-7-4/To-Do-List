...
function showTasksList() {
  ...
  <div class="ui icon warning message" style="background-color: #FFB6C1;">
    <i class="cloud icon"></i>
    <div class="content">
      <div class="header">Oops, the task cloud seems empty!</div>
      <div>Why not let your imagination rain down some tasks?</div>
    </div>
  </div>
`;
...
function clearAllTasks() {
  ...
  new Noty({
    type: "error",
    text: '<i class="close icon"></i> No tasks to remove.',
    layout: "bottomRight",
    timeout: 2000,
    progressBar: true,
    closeWith: ["click"],
